...
#define _USE_FIND \
    0 /**< This option switches filtered directory read functions, f_findfirst() and
...
#define _USE_CHMOD \
    0 /**< This option switches attribute manipulation functions, f_chmod() and f_utime().
/  (0:Disable or 1:Enable) Also _FS_READONLY needs to be 0 to enable this option. */

#define _USE_LABEL \
    0 /**< This option switches volume label functions, f_getlabel() and f_setlabel().
/  (0:Disable or 1:Enable) */

#define _USE_FORWARD \
    0 /**< This option switches f_forward() function. (0:Disable or 1:Enable) */
...
#define _VOLUME_STRS                                   \
    "RAM", "NAND", "CF", "SD1", "SD2", "USB1", "USB2", \
        "USB3" /**< _STR_VOLUME_ID switches string support of volume ID.
...
#define _MULTI_PARTITION \
    0               /**< 0:Single partition, 1:Multiple partition
...
#define _USE_TRIM \
    0 /**< This option switches support of ATA-TRIM. (0:Disable or 1:Enable)
...
#define _SYNC_t \
    osSemaphoreId /**< The option _FS_REENTRANT switches the re-entrancy (thread safe) of the FatFs
...
#include <stdlib.h>
#define ff_malloc \
    malloc /**< define the ff_malloc ff_free macros as standard malloc free */
#define ff_free \
    free /**< define the ff_malloc ff_free macros as standard malloc free */
#endif
