...
#define USBD_PRODUCT_STRING_HS "Dubby"
...
#define USBD_PRODUCT_STRING_FS "Dubby"
...
uint8_t *
USBD_FS_USRStringDesc(USBD_SpeedTypeDef speed, uint8_t idx, uint16_t *length);
...
#ifdef USBD_SUPPORT_USER_STRING_DESC
uint8_t *
USBD_HS_USRStringDesc(USBD_SpeedTypeDef speed, uint8_t idx, uint16_t *length);
#endif /* USBD_SUPPORT_USER_STRING_DESC */
...
uint8_t *USBD_HS_ConfigStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
    ...
    {
        USBD_GetString(
            (uint8_t *)USBD_CONFIGURATION_STRING_HS, USBD_StrDesc, length);
    }
    else
    {
        USBD_GetString(
                                        ...
                                        uint16_t *        length)
{
    ...
    {
        USBD_GetString(
            (uint8_t *)USBD_INTERFACE_STRING_HS, USBD_StrDesc, length);
    }
    else
    {
        USBD_GetString(
                                        ...
                                        uint16_t *        length)
{
    ...
    {
        USBD_GetString(
            (uint8_t *)USBD_INTERFACE_STRING_FS, USBD_StrDesc, length);
    }
    else
    {
        USBD_GetString(
